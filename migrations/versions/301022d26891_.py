...
Revision ID: 301022d26891
Revises: 
Create Date: 2020-08-17 21:09:35.881763
...
def upgrade():
    ...
    sa.Column('history_of_pharmacy_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['acceptance_of_item_id'], ['Acceptance_of_item.id'], ),
    sa.ForeignKeyConstraint(['availabilty_of_item_id'], ['Availabilty_of_item.id'], ),
    sa.ForeignKeyConstraint(['company_id'], ['Company.id'], ),
    sa.ForeignKeyConstraint(['doctor_id'], ['Doctor.id'], ),
    sa.ForeignKeyConstraint(['history_of_pharmacy_id'], ['History_of_pharmacy.id'], ),
    sa.ForeignKeyConstraint(['item_id'], ['Item.id'], ),
    sa.ForeignKeyConstraint(['pharmacy_id'], ['Pharmacy.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['User.id'], ),
    sa.ForeignKeyConstraint(['zone_id'], ['Zone.id'], ),
